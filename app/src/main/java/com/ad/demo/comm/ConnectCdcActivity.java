...
import com.ad.sio.usb.SioCdc;

import java.util.ArrayList;
import java.util.List;

@SuppressLint("HandlerLeak")
public class ConnectCdcActivity extends Activity {
    ...
    private void initUI() {
        ...
        mConectButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(
                        getApplicationContext(),
                        ((SioCdc) mSioBase).getItemName(mPortSpinner.getSelectedItemPosition()),
                        Toast.LENGTH_SHORT).show();

                PreferenceUtil.setPrefInt(mContext, "comport", mPosPort);
                PreferenceUtil.setPrefInt(mContext, "baudrate", mPosBaudrate);

                mSioBase.connect(((SioCdc) mSioBase).getItemName(mPortSpinner.getSelectedItemPosition()),
                        Integer.parseInt(mBaudSpinner.getSelectedItem().toString()));

            }
        });

        mPortArray = ((SioCdc) mSioBase).getListItems(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.connect_cdc);
